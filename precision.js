...
// The closest a ball and a wall cap can be // en español: "el punto más cercano entre una pelota y una tapa de pared"
...
const timeShockMazeElement = document.getElementById("time-shock-maze"); // Time maze element for the time it took to complete the maze
const timeMazeElement = document.getElementById("time-maze"); // Time maze element for the time it took to complete the maze
const shockMazeElement = document.getElementById("shock-maze"); // Shock maze element for the time it took to complete the maze
...
const ballSize = 20; // Width and height of the ball
const holeSize = 18;
...
function timeRestingTick() {
  timeMazeElement.innerHTML = `Time: ${timeResting}`;
  if (timeResting > 0) setTimeout(timeRestingTick, 1000);
}

function shockwaveTick() {
  shockMazeElement.innerHTML = `Shock: ${shockwave}`;
}
